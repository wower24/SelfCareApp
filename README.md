# SelfCareApp
 ...
 The Application starts with an affirmation screen that loads a random affirmation from the database.
 Affirmations are good for reprogramminng subconsciousness.
 The user can go to the journal by clicking on "continue" button.
